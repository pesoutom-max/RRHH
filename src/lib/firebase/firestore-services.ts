...
export async function submitApplication(
  ...
  const payload: Application = {
    ...
    hasFoodHandlingExperience: values.hasFoodHandlingExperience,
    hasCustomerServiceExperience: values.hasCustomerServiceExperience,
    ...
    cvFileUrl,
    answers: {
      canWorkSaturdays: values.canWorkSaturdays,
      canWorkSundaysOrHolidays: values.canWorkSundaysOrHolidays,
      hasCustomerServiceExperience: values.hasCustomerServiceExperience,
      hasFoodHandlingExperience: values.hasFoodHandlingExperience,
      canCommuteIndependently: values.canCommuteIndependently,
      availableFrom: values.availableFrom,
      interestReason: values.interestReason,
      mainStrength: values.mainStrength
    },
    score: null,
    status: "new",
    adminNotes: "",
